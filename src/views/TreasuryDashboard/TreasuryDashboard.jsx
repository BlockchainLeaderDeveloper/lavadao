...
{/* 
              ...
              <Box className="metric index" style={{"width":"40%", "margin-right":"9%"}}>
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sLAVADAO accumulated since the beginning of staking. Basically, how much sLAVADAO one would have if they staked and held a single LAVADAO from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sLAVADAO" : <Skeleton type="text" />}
                </Typography>
              </Box>
