                  ...
                  <>
                          ...
                          (!hasAllowance("valdao") && view === 0) || (!hasAllowance("svaldao") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>LAVADAO</b>?
                                    <br />
                                    Please approve LAVA DAO to use your <b>LAVADAO</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sLAVADAO</b>?
                                    <br />
                                    Please approve LAVA DAO to use your <b>sLAVADAO</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                    ...
                    <div className={`stake-user-data`}>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sLAVADAO</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sLAVADAO</>}
                        </Typography>
                      </div>
